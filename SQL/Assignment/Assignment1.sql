use AssignmentDb
-----Departments table and details,Displaying details----------
...
(
 ...
 insert into tblDepartments(Deptno,Dname,Loc) values (10, 'Design', 'Pune'),(20, 'Development', 'Pune'),
(30, 'Testing', 'Mumbai'),(40, 'Document', 'Mumbai')

select * from tblDepartments

-------------------------------------------------------------------------------------------------------------------------------------------
----Employees table and details,Displaying details------
...
Deptno numeric(2) foreign key references tblDepartments(Deptno)
)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------
---Client table and details,Displaying details----
...
insert into tblClients(Client_id,Cname,Address,Email,Phone,Buisness) values
...
---------------------------------------------------------------------------------------------------------------------------------
---Projects table and details,Displaying details----
...
----------------------------------------------------------------------------------------------------------------------------------------------------
----Employees project and task status table and details,Displaying details------
